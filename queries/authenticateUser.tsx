...
import { baseSepolia, createBundlerClient } from "@alchemy/aa-core";
...
export const useAuthenticateUser = (signer: AlchemySigner | undefined) => {
   ...
   const { mutate: authenticatedUser, isPending: isAuthenticatingUser } = useMutation({ mutationFn: signer?.authenticate, onSuccess: authUser })
